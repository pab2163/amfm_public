...
ggsave(raw_summary_familiar_unfamiliar, file = '../../results/supplemental_figs/sfig4_prompted_recall_summary.png',
       width = 8, height = 4)
...
ggsave(liking_plot, file = '../../results/supplemental_figs/sfig3_liking_condition.png',
       width = 4, height = 4)
```
